...
bool TileRenderer::tesselateBlockInWorld(uint8_t id, int lx, int ly, int lz, int cx, int cz) {
  ...
  if (isStairId(id)) {
    ...
    // One stair block should still keep full vertical side gradient like other
    // smooth-lit blocks; sample bottom side vertices from the lower neighbor.
