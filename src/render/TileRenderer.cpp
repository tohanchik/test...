...
bool TileRenderer::tesselateBlockInWorld(uint8_t id, int lx, int ly, int lz, int cx, int cz) {
  ...
  if (isStairBlock(id)) {
    ...
    if (needFace(lx, ly, lz, cx, cz, id, -1, 0, 0, isFancy)) {
      ...
      t->addQuad(uSideHalf, vSide0, uSide1, vSideHalf, westC01, westC11, westC00, westC10,
    ...
    if (needFace(lx, ly, lz, cx, cz, id, 1, 0, 0, isFancy)) {
      ...
      t->addQuad(uSideHalf, vSide0, uSide1, vSideHalf, eastC11, eastC01, eastC10, eastC00,
