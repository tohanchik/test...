...
bool TileRenderer::tesselateCrossInWorld(uint8_t id, int lx, int ly, int lz, int cx, int cz) {
  ...
  float brightness = (skyL + blkL * (1.0f - skyL));
...
bool TileRenderer::tesselateBlockInWorld(uint8_t id, int lx, int ly, int lz, int cx, int cz) {
  ...
  auto pickTess = [&](Tesselator *skyTess, Tesselator *fncTess,
    ...
    if ((blkL * (1.0f - skyL)) > 0.02f) return m_emitTess;
    return skyTess;
  };
  ...
  if (needFace(lx, ly, lz, cx, cz, id, 0, 1, 0, isFancy)) {
    ...
    uint32_t c00 = applyLightToFace(LIGHT_TOP, (sl00 + bl00 * (1.0f - sl00)));
    uint32_t c10 = applyLightToFace(LIGHT_TOP, (sl10 + bl10 * (1.0f - sl10)));
    uint32_t c01 = applyLightToFace(LIGHT_TOP, (sl01 + bl01 * (1.0f - sl01)));
    uint32_t c11 = applyLightToFace(LIGHT_TOP, (sl11 + bl11 * (1.0f - sl11)));
  ...
  if (needFace(lx, ly, lz, cx, cz, id, 0, -1, 0, isFancy)) {
    ...
    Tesselator *t = pickTess(m_opaqueTess, m_fancyTess, avgSky, avgBlk, isFancy);
    uint32_t c00=applyLightToFace(LIGHT_BOT, (sl00 + bl00 * (1.0f - sl00)));
    uint32_t c10=applyLightToFace(LIGHT_BOT, (sl10 + bl10 * (1.0f - sl10)));
    uint32_t c01=applyLightToFace(LIGHT_BOT, (sl01 + bl01 * (1.0f - sl01)));
    uint32_t c11=applyLightToFace(LIGHT_BOT, (sl11 + bl11 * (1.0f - sl11)));
  ...
  if (needFace(lx, ly, lz, cx, cz, id, 0, 0, -1, isFancy)) {
    ...
    Tesselator *t=pickTess(m_opaqueTess,m_fancyTess,avgSky,avgBlk,isFancy);
    uint32_t c11=applyLightToFace(LIGHT_SIDE,(sl11 + bl11 * (1.0f - sl11)));
    uint32_t c01=applyLightToFace(LIGHT_SIDE,(sl01 + bl01 * (1.0f - sl01)));
    uint32_t c10=applyLightToFace(LIGHT_SIDE,(sl10 + bl10 * (1.0f - sl10)));
    uint32_t c00=applyLightToFace(LIGHT_SIDE,(sl00 + bl00 * (1.0f - sl00)));
