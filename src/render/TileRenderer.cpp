...
bool TileRenderer::tesselateBlockInWorld(uint8_t id, int lx, int ly, int lz, int cx, int cz) {
  ...
  if (needFace(lx, ly, lz, cx, cz, id, 0, 1, 0, isFancy)) {
    ...
    uint32_t c00 = applyLightToFace(LIGHT_TOP, ((bl00 > sl00) ? bl00 : sl00));
    uint32_t c10 = applyLightToFace(LIGHT_TOP, ((bl10 > sl10) ? bl10 : sl10));
    uint32_t c01 = applyLightToFace(LIGHT_TOP, ((bl01 > sl01) ? bl01 : sl01));
    uint32_t c11 = applyLightToFace(LIGHT_TOP, ((bl11 > sl11) ? bl11 : sl11));
  ...
  if (needFace(lx, ly, lz, cx, cz, id, 0, -1, 0, isFancy)) {
    ...
    Tesselator *t = pickTess(m_opaqueTess, m_fancyTess, avgSky, avgBlk, isFancy);
    uint32_t c00=applyLightToFace(LIGHT_BOT, ((bl00 > sl00) ? bl00 : sl00));
    uint32_t c10=applyLightToFace(LIGHT_BOT, ((bl10 > sl10) ? bl10 : sl10));
    uint32_t c01=applyLightToFace(LIGHT_BOT, ((bl01 > sl01) ? bl01 : sl01));
    uint32_t c11=applyLightToFace(LIGHT_BOT, ((bl11 > sl11) ? bl11 : sl11));
  ...
  if (needFace(lx, ly, lz, cx, cz, id, 0, 0, -1, isFancy)) {
    ...
    Tesselator *t=pickTess(m_opaqueTess,m_fancyTess,avgSky,avgBlk,isFancy);
    uint32_t c11=applyLightToFace(LIGHT_SIDE,((bl11 > sl11) ? bl11 : sl11));
    uint32_t c01=applyLightToFace(LIGHT_SIDE,((bl01 > sl01) ? bl01 : sl01));
    uint32_t c10=applyLightToFace(LIGHT_SIDE,((bl10 > sl10) ? bl10 : sl10));
    uint32_t c00=applyLightToFace(LIGHT_SIDE,((bl00 > sl00) ? bl00 : sl00));
