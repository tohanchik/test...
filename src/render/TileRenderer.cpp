...
bool TileRenderer::tesselateBlockInWorld(uint8_t id, int lx, int ly, int lz, int cx, int cz) {
  ...
  if (isStairBlock(id)) {
    ...
    if (needFace(lx, ly, lz, cx, cz, id, -1, 0, 0, isFancy)) {
      ...
      t->addQuad(uSideHalf, vSide0, uSide1, vSideHalf, cTop, cTop, cTop, cTop,
    ...
    uint32_t riser = lightForFace(LIGHT_SIDE, 0, 0, -1, 0.92f);
    t->addQuad(uSide0, vSide0, uSide1, vSideHalf, riser, riser, riser, riser,
