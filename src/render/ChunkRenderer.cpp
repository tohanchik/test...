...
void ChunkRenderer::render(float camX, float camY, float camZ) {
  ...
  // Keep a stable additive pass with moderate strength to avoid daytime
  // overexposure on bright materials (sand/snow).
  sceGuBlendFunc(GU_ADD, GU_FIX, GU_FIX, 0xD0D0D0D0, 0xFFFFFFFF);
