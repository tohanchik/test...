...
void ChunkRenderer::render(float camX, float camY, float camZ) {
  ...
  // Keep a stable additive pass. Slightly stronger source to better match the
  // expected visual reach of level-15 block light.
  sceGuBlendFunc(GU_ADD, GU_FIX, GU_FIX, 0xE0E0E0E0, 0xFFFFFFFF);
