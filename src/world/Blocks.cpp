...
void Blocks_Init() {
  ...
  DEF_PROPS(BLOCK_WOOD_STAIR, 15, 0, 15, SOLID);
  DEF_PROPS(BLOCK_COBBLE_STAIR, 20, 0, 15, SOLID);
  DEF_PROPS(BLOCK_STONE_STAIR, 15, 0, 15, SOLID);
  DEF_PROPS(BLOCK_SANDSTONE_STAIR, 8, 0, 15, SOLID);
  DEF_PROPS(BLOCK_BRICK_STAIR, 20, 0, 15, SOLID);
  DEF_PROPS(BLOCK_STONE_BRICK_STAIR, 25, 0, 15, SOLID);
