...
static void game_render() {
  ...
  // MCPE 0.6.1-like first-person camera offset:
  // apply a small forward view-space offset (~0.1 block) to reduce close-wall slicing.
  if (g_level && g_player) {
    const float camForwardBias = 0.10f;
